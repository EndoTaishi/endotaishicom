...
import {faTwitter, faGithub, faDribbble,} from '@fortawesome/free-brands-svg-icons'
library.add(faTwitter, faGithub, faDribbble, )
      ...
      <Container>
        <div className="flex justify-between items-center mt-20 py-20 border-t border-paleyYellow-dark">
          ...
          <div className="flex">
            ...
            >
                <FontAwesomeIcon icon={faDribbble} width="24" />
            </a>
            <a
